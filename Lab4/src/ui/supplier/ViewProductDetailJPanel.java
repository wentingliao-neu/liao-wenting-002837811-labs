...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        btnAddFeature.setEnabled(false);
        btnRemoveFeature.setEnabled(false);
         JOptionPane.showMessageDialog(this, "Productinformation saved", "Information", JOptionPane.INFORMATION_MESSAGE);
         refreshTable();
...
saveFeatures();
       int row=tblFeatures.getSelectedRow();
        if(row<0){
            JOptionPane.showMessageDialog(null,"Please select a row fron the table first.","Warning",JOptionPane.WARNING_MESSAGE);
            return;
        }
