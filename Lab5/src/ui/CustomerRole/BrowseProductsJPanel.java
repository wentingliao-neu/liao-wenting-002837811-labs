...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please check the modified quantity fields", "Info", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        
        int oldQuant=item.getQuantity();
        if(item.getProduct().getAvail()+oldQuant-quant<0){
                JOptionPane.showMessageDialog(this, "Please check the availability.", "Info", JOptionPane.INFORMATION_MESSAGE);
                return;
            }    
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please check the price and quantity fields", "Info", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if(salesPrice<product.getPrice()){
            JOptionPane.showMessageDialog(this, "Price should be more than it is set in the price", "Info", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
